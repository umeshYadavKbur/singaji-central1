...
function Pagination(
    ...
    return (
        <div style={{ border: "rgb(246 249 252)", height: "100%", width: "100%" }} className="d-flex mb-4 mt-2">
            <div className="mx-4" style={{ height: "100%", width: "50%" }}>
            ...
            <div style={{ display: "flex", height: '100%', minWidth: "50%", justifyContent: "center" }}>
                <div className="me-3" style={{ justifyContent: 'center', display: 'flex', alignItems: 'center' }}>
                    <button

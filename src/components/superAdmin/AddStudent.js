                  ...
                  <div className="col px-4 ">
                    ...
                    <div className="row">
                      <div className="col">
                        ...
                        <select name="school12Subject" value={formik.values.school12Subject} onChange={formik.handleChange} className="form-select" id="inputGroupSelect02">
                          <option selected values="">12 Subject</option>
                      ...
                      <div className="col">
                        <label htmlFor="">12<sup>th</sup> Roll No.</label>
                        <input name="schoolName" value={formik.values.schoolName} onChange={formik.handleChange} type="text" className="form-control" placeholder="School name" />
                        {formik.errors.schoolName && formik.touched.schoolName ? (
                          <div className="text-danger fs-6">{formik.errors.schoolName}</div>
                        ) : ''}</div>
                    ...
                    <div className="row">
                      ...
                      <div className="col">
                        ...
                        {formik.errors.percentage10 && formik.touched.percentage10 ? (
                          <div className="text-danger fs-6">{formik.errors.percentage10}</div>
                        ) : ''}
                      </div>
                    </div>
                    <div className="row">
                      ...
                      <div className="col">
                        ...
                        <select name="branchName" value={formik.values.branchName} onChange={formik.handleChange} className="form-select" id="inputGroupSelect02">
                          <option selected values="">Branch</option>
                          <option value="BCA">BCA</option>
                          <option value="BSC bt">BSC bt</option>
                          <option value="BSC mrc">BSC mrc</option>
                          <option value="Bcom">Bcom</option>
                        </select>{formik.errors.branchName && formik.touched.branchName ? (
                    ...
                    <div className="row">
                      ...
                      <div className="col">
                        ...
                        <input name="pincode" value={formik.values.pincode} onBlur={formik.handleBlur = () => {getPincode()}} onChange={formik.handleChange} type="text" className="form-control" placeholder="Pincode" />
                        {formik.errors.pincode && formik.touched.pincode ? (
                          <div className="text-danger fs-6">{formik.errors.pincode}</div>
                        ) : ''}
                      </div>
                      <div className="col">
                  ...
                  <div className="col px-4">
                    <div className="row">
                      ...
                      <div className="col">
                        ...
                        <select name="category" value={formik.values.category} onChange={formik.handleChange} className="form-select" id="inputGroupSelect02">

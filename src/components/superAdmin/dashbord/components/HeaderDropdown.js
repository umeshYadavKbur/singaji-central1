    ...
    return (
        <CDropdown variant="nav-item">
            ...
            <CDropdownMenu className="pt-0" placement="bottom-end">
                <div style={{ height: '50px', width: '50px', justifyContent: 'center', alignItems: 'center', }}>
                    {/* <img  src={avatar8} alt="logo" /> */}
                    <CAvatar src={avatar8} size="lg" style={{ margin: '10% 120%', }} />
                    <p style={{ width: '320%', fontSize: '12px', textAlign: 'center', fontWeight: 'bold' }}>roshany.bca2020@ssism.org</p>
                </div>

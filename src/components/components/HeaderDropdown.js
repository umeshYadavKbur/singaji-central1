...
const AppHeaderDropdown = ({ userData, logout }) => {
  ...
  return (
    <CDropdown variant="nav-item" >
      ...
      <CDropdownMenu component={'div'} className="pt-0 " placement="bottom-end" style={{ backgroundColor: '#7e84a3', marginLeft: '-223px', height: '-webkit - fill - available' }} >
        <div style={{ flexDirection: 'column', backgroundColor: '#7e84a3', minHeight: '369px', width: '294px', alignItems: 'center', paddingTop: '49px', display: 'flex', flex: 'basis' }}>
          <CAvatar
            src={avatar8}
            style={{
              height: "82px",
